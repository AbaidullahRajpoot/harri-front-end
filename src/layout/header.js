...
import Sitelogo from "@assets/img/logo/logo-black.svg";
    ...
    <>
      <header>
        <div className={`header__area ${style_2 ? "" : "header__transparent"}`}>
          <div
            className={`header__bottom-13 header__padding-7 header__black-3 ${
              style_2 ? "header__bottom-13-white" : "theme-bg-gray"
